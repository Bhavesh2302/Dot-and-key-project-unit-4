...
export const BestSeller = () => {
  ...
  // className={index === divindex ? "swiper swiper-slide" : "swiper"}
          ...
          {data.bestseller.map((d,index) => (
            <SwiperSlide key={d.id}   >
              <div className={styles.bhbestsellerdatadiv}>
                ...
                <div className={styles.bhbestsellermainpricediv}>
                  {" "}

                  <div className={styles.bhbestsellerstikedpricediv}>Rs. {d.strikedprice}</div>
                  <div className={styles.bhbestsellerpricediv}>
                    {" "}
                    Rs. {d.price}
                  </div>
