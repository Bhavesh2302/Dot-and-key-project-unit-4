...
export const NewArrival=() => {
 ...
 <div className={styles.bhnewarrivalmainpricediv}>
                  {" "}

                  <div className={styles.bhnewarrivalstikedpricediv}>Rs. {d.strikedprice}</div>
                  <div className={styles.bhnewarrivalpricediv}>
                    {" "}
                    Rs. {d.price}
                  </div>
